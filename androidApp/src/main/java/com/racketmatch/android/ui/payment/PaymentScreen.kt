package com.racketmatch.android.ui.payment
        ...
        val paymentSheet = rememberPaymentSheet { result ->
            when (result) {
                ...
                is PaymentSheetResult.Failed ->
                    viewModel.onEvent(PaymentEvent.PaymentFailed(result.error.message))
                    ...
                    is PaymentEffect.LaunchPayment -> {
                        paymentSheet.presentWithPaymentIntent(
                            ...
                            configuration = PaymentSheet.Configuration(
                                merchantDisplayName = "RacketMatch"
                            )
                        )
                    }
        ...
        Scaffold(
            ...
            when (state) {
                ...
                PaymentState.Idle -> Column(
                    ...
                    Button(
                        onClick = { viewModel.onEvent(PaymentEvent.SubscribeNow) },
